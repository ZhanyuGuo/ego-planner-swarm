...
ros::Publisher _all_map_pub;  // only publish global map as a simulator
...
double _z_limit, _resolution, _sense_rate, _min_dist;
// double _sensing_range, _init_x, _init_y;
...
int main(int argc, char** argv)
{
  ...
  // _click_sub = n.subscribe("/move_base_simple/goal", 10, clickCallback);
